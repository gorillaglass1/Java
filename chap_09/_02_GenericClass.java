...
public class _02_GenericClass {
    public static void main(String[] args) {
        ...
        orderCoffee(37, "라떼");
        //        CoffeeByUser<User> c9 = new CoffeeByUser<>(new BlackBox("블랙박스"));
    }
    public static <T> void orderCoffee(T user) {
        System.out.println("커피 준비 완료 : " + user);
    }

    public static <T, V> void orderCoffee(T user, V coffee) {
        System.out.println(coffee + " 준비 완료 : " + user);
    }
}
